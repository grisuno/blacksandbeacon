...
- Symbols:
  ...
  - `fprintf` (function, line 26) `fprintf(stderr, "config error: %s\n", err);`
  - `hex_encode` (function, line 31) `hex_encode(cfg.crypto.key, BSB_AES_KEY_BYTES, key_hex);`
  - `printf` (function, line 32) `printf("c2.url=%s\n", cfg.c2.url);`
...
- Language: c
- Symbols:
  - `hex_to_bytes` (function, line 11) `static int hex_to_bytes(const char *hex, unsigned char *out, size_t outlen)`
  - `main` (function, line 22) `int main(int argc, char **argv)`
  - `fprintf` (function, line 31) `fprintf(stderr, "usage: %s --key <64hex> --plain <text>\n", argv[0]);`
  - `printf` (function, line 37) `printf("FAIL:bad-key\n");`
  - `free` (function, line 50) `free(cipher);`
  - `snprintf` (function, line 68) `snprintf(hex + i*2, 3, "%02x", cipher[i]);`
