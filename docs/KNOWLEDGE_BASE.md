...
- `bof.c` <-> `config.c` (7 hops, across 3 communities)
- `bof.c` <-> `config_harness.c` (7 hops, across 3 communities)
- `beacon.h` <-> `config.c` (6 hops, across 3 communities)
- `beacon.h` <-> `config_harness.c` (6 hops, across 3 communities)
- `bof.c` <-> `config.h` (6 hops, across 3 communities)
...
- How are the 16 files in 'root' related to each other?
- Why are bof.c and config.c connected through 7 hops across 3 communities?
...
graph TD
    ...
    subgraph community_3 ["c2"]
    c2_server_py["server.py (py)"]
    class c2_server_py mod;
    end
    subgraph community_1 ["beacons/v1"]
    ...
    subgraph community_2 ["bof/include"]
