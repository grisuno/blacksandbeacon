...
- Language: c
- Symbols:
  - `user_in_group` (function, line 15) `static int user_in_group(const char *group, const char *username, char *filebuf, long filesize)`
  - `go` (function, line 57) `void go(char *args, int alen)`
- Depends on: `bof/include/beacon_api.h`, `bof/include/syscalls.h`

## bof/is_sudo/is_sudo.c
- Layer: utility
- Doc: is_sudo.c — LazyOwn RedTeam BOF (Linux/x64) gcc -c -nostdlib -fPIC -m64 -O2 is_sudo.c -o is_sudo.x64.o  Tipos
- Language: c
- Symbols:
  ...
  - `syscall1` (function, line 33) `static inline long syscall1(long n, long a1)`
  ...
  - `go` (function, line 109) `void go(char *args, int alen)`
