...
- Symbols:
  ...
  - `syscall1` (function, line 86) `syscall1(SYS_close, fd);`
  - `copy_group_members` (function, line 87) `copy_group_members("sudo", gbuf, total, sudo_members, sizeof(sudo_members));`
  - `BeaconPrintf` (function, line 93) `BeaconPrintf(CALLBACK_OUTPUT, "[userenum] cannot open /etc/passwd\n");`
